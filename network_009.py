...
# s_dict_savename1 = str(config["local_inputs_dir"]) + '/exp008_d_train_1850-1900.nc'
# s_dict_savename2 = str(config["local_inputs_dir"]) + '/exp008_d_val_1850-1900.nc'
# s_dict_savename3 = str(config["local_inputs_dir"]) + '/exp008_d_test_1850-1900.nc'
...
# # CREATE RANDOMIZED INPUTS TO TEST THE MODEL ----------------------------------------------------------------
# time = train_dat["y"].time
...
# # Create the dictionary of randomized data
# print("Creating dictionary")
# data_dict_train = {"x": data_array, "y": train_dat["y"]}
# data_dict_val = {"x": data_array, "y": val_dat["y"]}
# data_dict_test = {"x": data_array, "y": test_dat["y"]}

# # convert data to xarray from SampleClass object: 
# print("Converting to xarray")
# d_train_xr = xr.Dataset(data_dict_train)
# d_val_xr = xr.Dataset(data_dict_val)
# d_test_xr = xr.Dataset(data_dict_test)

# print("Saving randomized data")
# d_train_xr.to_netcdf(str(config["local_inputs_dir"]) + "/" + str(config["expname"]) + '_d_train_1850-1900.nc')
# d_val_xr.to_netcdf(str(config["local_inputs_dir"]) + "/" + str(config["expname"]) + '_d_val_1850-1900.nc')
# d_test_xr.to_netcdf(str(config["local_inputs_dir"]) + "/" + str(config["expname"]) + '_d_test_1850-1900.nc')
