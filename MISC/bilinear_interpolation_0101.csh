...
# Define directories: 
set input_dir = "/pscratch/sd/q/qinyi/E3SMv2_init/v2.LR.historical_0101/archive/atm/hist"
set output_dir = "/pscratch/sd/p/plutzner/E3SM/E3SMv2data/member0101/monthly_bilinear"
...
set input_files = `find "$input_dir" -name "v2.LR.historical_0101.eam.h0.1866-02.nc" -type f`
# set input_files = `find "$input_dir" -name "v2.LR.historical_0101.eam.h0.*.nc" -type f`
...
foreach input_file ($input_files)
    ...
    set base_name_short = `echo "$base_name" | sed -n 's/\(v2\.LR\.historical_0101\.eam\.h0\.\).*/\1/p'`
